...
# has-a mouth.”
# Take some time to make flash cards f
...
print(f"after urlopen, get {len(WORDS)} words")
...
# python3.7 ex41.py english

# What does result = sentence[:] do? That’s a Python way of copying a list. You’re using the
