...
# continue Don’t process more of the loop, do
# it again.
# while True: continue
...
# try Try this block, and if exception, go to
# except.
# try: pass
...
# Same thing for string formats: use them in some strings to know what they do. Older Python 2 code uses
